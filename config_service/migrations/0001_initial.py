# Generated by Django 2.1.1 on 2018-09-14 14:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('handler_type', models.IntegerField(choices=[(0, 'Update'), (1, 'Join'), (2, 'Validate'), (3, 'Transaction Matching')])),
                ...
                ('log_level', models.IntegerField(choices=[(0, 'Debug'), (1, 'Info'), (2, 'Warning'), (3, 'Error'), (4, 'Critical')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('bink_private_key', 'Bink private key'), ('bink_public_key', 'Bink public key'), ('merchant_public_key', 'Merchant public key'), ('compound_key', 'Compound key')], max_length=32)),
                ('key_to_store', models.FileField(blank=True, upload_to='form_data/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('request_type', models.CharField(choices=[('INBOUND', 'Inbound'), ('OUTBOUND', 'Outbound')], max_length=16)),
                ('type', models.IntegerField(choices=[(0, 'RSA'), (1, 'Open Auth (No Authentication)'), (2, 'OAuth')])),
                ('configuration', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='config_service.Configuration')),
            ],
        ),
        migrations.AddField(
