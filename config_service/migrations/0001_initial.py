# Generated by Django 2.0.7 on 2018-07-05 13:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('security_service', models.IntegerField(choices=[(0, 'RSA')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('bink_private_key', 'Bink private key'), ('bink_public_key', 'Bink public key'), ('merchant_public_key', 'Merchant public key')], max_length=32)),
